                                        ...
                                        <div className="flex items-center gap-3">
                                            {notice.requiresAck && !notice.hasAcknowledged ? (
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 px-3 py-1 bg-bank-teal text-white text-[9px] font-black uppercase tracking-widest rounded-lg hover:bg-opacity-90 shadow-sm transition-all animate-in fade-in duration-300"
                                                >
                                                    <CheckCircle size={12} />
                                                    Acknowledge
                                                </button>
                                            ) : notice.requiresAck && notice.hasAcknowledged ? (
                                                <span className="flex items-center gap-1.5 text-green-600 text-[9px] font-black uppercase tracking-widest bg-green-50 px-2 py-1 rounded-lg border border-green-100">
                                                    <CheckCircle size={12} />
                                                    Acknowledged
                                                </span>
                                            ) : null}
