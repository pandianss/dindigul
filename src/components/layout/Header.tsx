        ...
        <header className="h-20 bg-white border-b border-gray-200 px-8 flex items-center justify-between shrink-0">
            ...
            <div className="flex items-center space-x-6">
                <button
                    ...
                    className="p-2 flex items-center justify-center hover:bg-gray-100 rounded-full text-gray-500 relative"
                >
                    <Bell size={20} />
                    {unreadCount > 0 && (
                        <span className="absolute max-w-[20px] top-0.5 right-0.5 flex items-center justify-center min-w-[16px] h-4 bg-red-500 rounded-full text-[10px] font-bold text-white border-2 border-white pointer-events-none ring-1 ring-red-500/20 shadow-sm animate-pulse">
