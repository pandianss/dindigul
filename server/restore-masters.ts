...
async function main() {
    ...
    const depts = [
        ...
        { code: 'HRD', nameEn: 'Human Resource Development', nameTa: 'மனித வள மேம்பாடு', nameHi: 'मानவ संसाधन विकास' },
    ...
    const designations = [
        ...
        { code: 'AGM', nameEn: 'Assistant General Manager', nameTa: 'உதவி பொது மேலாளர்', nameHi: 'सहायक महाப்பிரதிநிதி', workId: 20 },
